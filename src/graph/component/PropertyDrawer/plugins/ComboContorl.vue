    ...
    <el-descriptions title="字体" :column="2" :colon="false" :labelStyle="{ display: 'none' }">
      ...
      <el-descriptions-item>
        <el-form-item label="refX" class="my-0">
          <el-slider class="w-36" v-model="form.label.refX" :min="-50" :max="150" :marks="sliderMarks" @input="val => propertyChange('label/refX', val)" />
        </el-form-item>
      </el-descriptions-item>

      <el-descriptions-item>
        <el-form-item label="refY" class="my-0">
          <el-slider class="w-36" v-model="form.label.refY" :min="-50" :max="150" :marks="sliderMarks" @input="val => propertyChange('label/refY', val)" />
        </el-form-item>
      </el-descriptions-item>

      <el-descriptions-item :span="2">
        <el-form-item label="显示字体" class="my-0">
